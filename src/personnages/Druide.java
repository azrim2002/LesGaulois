...
public class Druide {
	...
	private void preparerPortion() {
        ...
        if (nouvelleForcePotion > 7) {
            System.out.println("Le druide " + nom + " a préparé une super potion de force : " + forcePotion);
        } else {
            System.out.println("Le druide " + nom + " n'a pas trouvé tous les ingrédients, sa potion est seulement de force : " + forcePotion);
          }
        }
